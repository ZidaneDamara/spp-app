                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                        ...
                                        <a href="apps-calendar.html" class="dropdown-item"><i
                                                class="fe-calendar mr-1"></i> Calendar</a>
                                        <a href="apps-chat.html" class="dropdown-item"><i
                                                class="fe-message-square mr-1"></i> Chat</a>
                                        <div class="dropdown">
                                        ...
                                        <div class="dropdown">
                                            <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                                id="topnav-crm" role="button" data-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <a href="apps-social-feed.html" class="dropdown-item"><i
                                                class="fe-rss mr-1"></i> Social Feed</a>
                                        <a href="apps-companies.html" class="dropdown-item"><i
                                                class="fe-activity mr-1"></i> Companies</a>
                                        ...
                                        <div class="dropdown">
                                            <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                                id="topnav-contact" role="button" data-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="dropdown">
                                            <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                                id="topnav-tickets" role="button" data-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <a href="apps-file-manager.html" class="dropdown-item"><i
                                                class="fe-folder-plus mr-1"></i> File Manager</a>
                                    </div>
                                </li>
