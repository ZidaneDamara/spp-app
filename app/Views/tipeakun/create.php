...
<?= $this->section('title') ?>Tambah Jenis Akun<?= $this->endSection() ?>
...
<div class="content">
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Tambah Jenis Akun</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Tambah Data Jenis Akun</h4>
                </div>
        ...
        <form action="<?= base_url('tipe-akun/store') ?>" method="post">
            <?= csrf_field() ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="text-right mt-3">
                        ...
                        <a href="<?= base_url('tipe-akun') ?>" class="btn btn-secondary">Batal</a>
                    </div>
                </div>
            </div>
        </form>
