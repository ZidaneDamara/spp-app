...
<?= $this->section('title') ?>Edit Akun<?= $this->endSection() ?>
...
<div class="content">
    <div class="container-fluid">
        ...
        <form action="<?= base_url('akun/update/' . $akun['id_akun']) ?>" method="post">
            <?= csrf_field() ?>
            ...
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="kode" class="form-control"
                                    value="<?= old('kode', $akun['kode']) ?>" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="id_jenis" class="form-control" required>
                                    ...
                                    <option value="<?= $ja['id_jenis'] ?>"
                                        <?= old('id_jenis', $akun['id_jenis']) == $ja['id_jenis'] ? 'selected' : '' ?>>
                                        <?= esc($ja['nama_jenis']) ?>
                                    </option>
                                    <?php endforeach ?>
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="debet" class="form-control"
                                    value="<?= old('debet', $akun['debet']) ?>" step="0.01">
                            </div>

                            <div class="form-group col-md-6">
                                <label>Saldo Kredit</label>
                                <input type="number" name="kredit" class="form-control"
                                    value="<?= old('kredit', $akun['kredit']) ?>" step="0.01">
                            </div>
                    ...
                    <div class="text-right mt-3">
                        ...
                        <a href="<?= base_url('akun') ?>" class="btn btn-light">Batal</a>
                    </div>
                </div>
            </div>
        </form>
